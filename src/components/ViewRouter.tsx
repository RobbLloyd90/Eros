  ...
  return (
    <div style={{ position: 'relative', flex: 1, overflow: 'hidden', marginTop: '4px' }}>
      <AnimatePresence initial={false} mode="wait">
        {
        props.view === 'settings' && <SettingsView
        key="settings"
        theme={props.theme}
        tStyle={props.tStyle}
        ...
        {
        props.view === 'dashboard' && <Dashboard
        key="dashboard"
        theme={props.theme}
        tStyle={props.tStyle}
        isLight={props.isLight}
        ...
        tStyle={props.tStyle}
        isLight={props.isLight}
        onSelectMonth={(m) => { props.setCurrentMonth(m); props.setView('month'); }} />
        }
        
        {
        props.view === 'food' && <FoodView
        key="food"
        foodEntries={props.activeFood}
        theme={props.theme}
        tStyle={props.tStyle}
        isLight={props.isLight}
        ...
        activeGoals={props.activeGoals}
        theme={props.theme}
        tStyle={props.tStyle}
        isLight={props.isLight}
        openEditEntry={props.openEditEntry}
